...
## Создан файл conftest.
([conftest.py](tests/conftest.py),[conftest.py](tests/conftest.py),[conftest.py](tests/conftest.py),[conftest.py](tests/conftest.py),[conftest.py](tests/conftest.py),[conftest.py](tests/conftest.py))

## Coзданы тесты 
*[test_filter_by_state.py] (tests/test_filter_by_state.py ) Тест фильтрации по умолчанию (EXECUTED).
*[test_get_mask_account.py] (tests/test_get_mask_account.py) проверяет функцию маскировки аккаунта.
*[test_get_mask_card_number.py] (tests/test_get_mask_card_number.py) проверяет функцию маскировки номера.
*[test_mask_account_or_card.py] (tests/test_mask_account_or_card.py) проверяет функцию маскировки акк или номера.
*[test_sort_by_date.py] (tests/test_sort_by_date.py) проверяет  дату: год, месяц, число. 
*[test_widget.py] (tests/test_widget.py), проверяет даты :число, месяц, год.